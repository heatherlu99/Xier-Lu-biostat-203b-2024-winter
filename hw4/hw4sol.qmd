...
server <- function(input, output) {
  ...
  observe({
    ...
    if (selected_variable() == "Lab_Measurement") {
    ...
    } else if (selected_variable() == "Vital_Measurements") {
      selected_vars_icu <- c("Heart Rate", "Non Invasive Blood Pressure systolic", "Non Invasive Blood Pressure diastolic", "Respiratory Rate", "Temperature Fahrenheit")
      ...
      output$summary_plot <- renderPlot({
        ggplot(mimic_icu_cohort, aes(x = !!sym(selected_variable()))) +
          geom_bar() +
          theme_minimal() +
