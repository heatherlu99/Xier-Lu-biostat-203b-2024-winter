...
mimic_recipe <- 
  ...
  step_impute_mean(
sodium, chloride, creatinine, potassium, glucose, hematocrit, wbc, bicarbonate, temperature_f, 
non_invasive_blood_pressure_systolic, respiratory_rate, heart_rate, age_at_intime) %>%
  step_impute_mode(first_careunit, admission_type, admission_location, insurance, language, marital_status,
                   race, gender) %>%
...
mimic_recipe <- 
  ...
  step_impute_mean(
sodium, chloride, creatinine, potassium, glucose, hematocrit, wbc, bicarbonate, temperature_f,
non_invasive_blood_pressure_diatolic, non_invasive_blood_pressure_systolic, respiratory_rate, heart_rate,
age_at_intime) %>%
  step_impute_mode(first_careunit, admission_type, admission_location, insurance, language, marital_status,
                   race, gender) %>%
  step_naomit(all_predictors()) %>%
