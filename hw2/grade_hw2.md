...
- Q1 (15/20)
  ...
  - Q1.1 Didn't talk about differences in data type (-3)
  
  - Q1.2 There is a warning. You didn't supply data types to the columns by name (-2)
...
- Q2 (78/80)
    ...
    - Q2.5 (14/15)
      ...
      - First ten rows aren't the same (-1)
...
-   Are the materials (files and instructions) submitted to the `main` branch sufficient for reproducing all the results? Just click the `Render` button will produce the final `html`? 
  ...
  - Line 87. Cannot set the directory to your directory. I can't run it (-2)
