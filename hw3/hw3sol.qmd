...
write_parquet(chartevents, "~/desktop/203hw/hw3/chartevents.parquet")
```
...
mimic_icu_cohort <- icustays_tble %>%
  ...
  select(-c(anchor_age.x, anchor_year.x, anchor_year_group.x, dod.x, gender.x, anchor_year.y, anchor_age.y, dod.y, anchor_year_group.y))
...
mimic_icu_cohort %>%
  ...
  geom_point() +
  labs(
    title = "Length of ICU stay vs insurance at intime",
